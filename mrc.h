 ...
 * 
 * Initialize the MRC library. struct mrc_context provides a container for all objects 
 * created under the MRC library. The primary function of this is to 
 ...
 * 
 * Posts a receive operation for RDMA w/ IMM operations on the 
 * specified QP. The semantics are like ibv_post_recv() 
 *  
 ...
 *  
 * @return 
 * Returns 0 on success, and -1 on failure. Error semantics like ibv_post_send(). 
 */ 
