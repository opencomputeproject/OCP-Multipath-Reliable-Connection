...
#define MRC_CTL_API_VER_SUBMINOR_OFFSET     0
...
#define MRC_CTL_API_VER(_major, _minor, _sub_minor) \
	(((_major) << MRC_CTL_API_VER_MAJOR_OFFSET) | \
	 ...
	 ((_sub_minor)) << MRC_CTL_API_VER_SUBMINOR_OFFSET)
...
/* API versions */
#define MRC_CTL_API_CURRENT_VERSION         MRC_CTL_API_VER(1, 0, 1)
...
/* Version validation */
#if MRC_CTL_API_VER_USED > MRC_CTL_API_CURRENT_VERSION
	#error "MRC_CTL_API_VER_USED is greater than MRC_CTL_API_CURRENT_VERSION"
...
#elif MRC_CTL_API_VER_USED == MRC_CTL_API_LAST_SUPPORTED_VERSION
    #warning "MRC_CTL_API_VER_USED is equal to MRC_CTL_API_LAST_SUPPORTED \
version, may become obsolete"
#endif

/*
 * Vendor-specific control API versioning
 *
 * These macros track a vendor-defined control API surface that evolves
 * independently of the core MRC control API.  The same MAJOR.MINOR.SUBMINOR
 * semantics apply.
 */

/* Vendor control API versions */
#define MRC_CTL_VENDOR_API_CURRENT_VERSION         MRC_CTL_API_VER(1, 0, 0)
#define MRC_CTL_VENDOR_API_LAST_SUPPORTED_VERSION  MRC_CTL_API_VER(0, 0, 0)

/* Vendor control API version selection macros */
#ifndef MRC_CTL_VENDOR_API_VER_USED
    #define MRC_CTL_VENDOR_API_VER_USED MRC_CTL_VENDOR_API_CURRENT_VERSION
#elif MRC_CTL_VENDOR_API_VER_USED == MRC_CTL_API_VER_LATEST
    #undef MRC_CTL_VENDOR_API_VER_USED
    #define MRC_CTL_VENDOR_API_VER_USED MRC_CTL_VENDOR_API_CURRENT_VERSION
#endif

/* Vendor control API version validation */
#if MRC_CTL_VENDOR_API_VER_USED > MRC_CTL_VENDOR_API_CURRENT_VERSION
    #error "MRC_CTL_VENDOR_API_VER_USED is greater than MRC_CTL_VENDOR_API_CURRENT_VERSION"
#elif MRC_CTL_VENDOR_API_VER_USED < MRC_CTL_VENDOR_API_LAST_SUPPORTED_VERSION
    #error "MRC_CTL_VENDOR_API_VER_USED is less than MRC_CTL_VENDOR_API_LAST_SUPPORTED_VERSION"
#elif MRC_CTL_VENDOR_API_VER_USED == MRC_CTL_VENDOR_API_LAST_SUPPORTED_VERSION
    #warning "MRC_CTL_VENDOR_API_VER_USED is equal to MRC_CTL_VENDOR_API_LAST_SUPPORTED_VERSION, \
may become obsolete"
#endif
